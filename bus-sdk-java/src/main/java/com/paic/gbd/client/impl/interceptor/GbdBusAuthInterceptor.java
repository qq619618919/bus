...
public class GbdBusAuthInterceptor extends AuthInterceptor {
    private String userAgent;
    private String ipAddress;
    private String clientId;

    public GbdBusAuthInterceptor(Account account, String userAgent) {
        super(account);
...
//        account.addAuthHeaders(reqBuilder);
    ...
    private String getClientId() {
        ...
        try {
            p.load(GbdBusAuthInterceptor.class.getClassLoader().getResourceAsStream(path));
