...
import com.paic.gbd.client.utils.CrcUtils;
...
public class MessageInputStream extends DataInputStream {
    public MessageInputStream(InputStream in, boolean enablePbCrc) throws Exception {
    ...
    private static class FramedBuffer extends InputStream {
        ...
        public FramedBuffer(InputStream inputStream, boolean enablePbCrc) throws Exception {
